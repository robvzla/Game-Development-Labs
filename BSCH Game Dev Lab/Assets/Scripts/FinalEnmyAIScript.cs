...
public class FinalEnmyAIScript : MonoBehaviour
{
	public enum State
	{
		Idle,
	...
	void Update()
	{
		...
		// Adjust the velocity of the Rigidbody2D to match the direction of the sprite
		_myRb.velocity = new Vector2(speed * anim.transform.localScale.x, _myRb.velocity.y);
